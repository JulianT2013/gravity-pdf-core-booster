...
use GFPDF\Plugins\CoreBooster\FieldDescription\Options\AddFields;
...
class TestAddFields extends WP_UnitTestCase {
	...
	public function test_add_template_option() {
		...
		$this->assertArrayHasKey( 'include_field_description', $results );
		...
		add_filter( 'gfpdf_override_field_descriptions', '__return_true' );
		$this->assertCount( 1, $this->class->add_template_option( [] ) );
	}
}