...
use GFPDF\Plugins\CoreBooster\ProductTable\Options\AddFields;
...
class TestAddFields extends WP_UnitTestCase {
	...
	public function test_add_template_option() {
		...
		$this->assertArrayHasKey( 'group_product_fields', $results );
		...
		add_filter( 'gfpdf_override_product_table', '__return_true' );
		$this->assertCount( 1, $this->class->add_template_option( [] ) );
	}
}